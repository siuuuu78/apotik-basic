    ...
    if(isset($_POST['kirim'])){
     $id_kontak = $_POST['id_kontak'];
        ...
        if(empty($nama) || empty($email)){
            ...
            $insert = mysqli_query($koneksi, "INSERT INTO kontak  VALUES
            ('$id_kontak', '$nama', '$email', '$pesan')");
            if($insert){
     ...
     <section>
          <div class="container">
               <div class="text-center">
                    ...
                    <p class="lead">Jika ada pertanyaan, jangan ragu untuk bertanya!!</p>
               </div>
          </div>
     </section>
                    ...
                    <div class="col-md-6 col-sm-12">
                         <form id="contact-form" role="form" action="" method="post">
                              <div class="col-md-12 col-sm-12">
                                   <input type="hidden" class= "form-control" name= "id_kontak">
