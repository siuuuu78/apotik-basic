...
<center>
   <div class="container">
      <div class="card mt-5" style="max-width: 300px;">
         <center>
            <img src="images/user-icon.png" class="card-img-top" alt="User Image" width="100%" height="auto">
         </center>
         <div class="card-body">
            <h5 class="card-title"><i>Nama : </i> <?= $fetch_profile['nama']; ?></h5>
            <p class="card-text"><i >Email : </i> <?= $fetch_profile['email']; ?></p>
            <p class="card-text"><i >No Telp : </i> <?= $fetch_profile['notelp']; ?></p>
            <p class="card-text"><i >Alamat : </i> <?= $fetch_profile['alamat']; ?></p>
            <a href="update_profil.php" class="btn btn-primary btn-sm">Update Info</a>
         </div>
      </div>
   </div>
</center>
